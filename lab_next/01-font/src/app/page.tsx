      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <ol className="list-inside list-decimal text-sm/6 text-center sm:text-left font-sans">
          <li className="mb-2 tracking-[-.01em]">
            Get started by editing <code className="bg-black/[.05] dark:bg-white/[.06] px-1 py-0.5 rounded font-[family-name:var(--font-pretendard)] font-semibold">src/app/page.tsx</code>.
          </li>
